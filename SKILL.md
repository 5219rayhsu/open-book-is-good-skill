...
description: 從官方開放試題資料復刻一套考古題自學系統的方法手冊：偵察資料源→下載轉檔→判斷式解析→題庫→裁圖→詳解（含查證紀律）→紅隊抽驗→build 單檔／網站；已跑通國考，正延伸嘗試臺灣升學（學測／會考）等公開試題。
---
...
→ 紅隊抽驗 → build 單檔／網站。已在國考跑通，方法正延伸嘗試臺灣升學（學測 GSAT／會考 CAP）
等其他公開試題。
