...
- 🔴 「另走某某路線」的註解要配一個可查的出口（2026-08-06）
- 🔴 落地頁的數字會嚴重過期，而資料層完全看不出來（2026-08-06）
- 🔴 一條沒有被載入的規則，寫在哪一層都一樣是零（2026-08-06）
- 三層文件（別混為一談）
...
## 🔴 衍生產物沒有呼叫者，就只會在有人記得的那天是新的（2026-08-09）
...
## 🔴 robots.txt 與 llms.txt 可以各自都對、合起來不可能同時遵守（2026-08-09）
...
## 逐題靜態頁做不到，但「逐題可被指名」做得到（2026-08-09）
